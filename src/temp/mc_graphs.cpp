...
// Declare the prototype for mc_complete_coloring - need dual-like of adj matrix to mark edge color, where clique search is only
// over connectinged nodes with particular edge color. Will be all to all search but can stop after traversal hops
// equal to clique size
